...
document.addEventListener('DOMContentLoaded', () => {
    ...
    async function fetchNews(query, limit) {
        try {
            const response = await fetch(`https://your-app-name.onrender.com/fetchNews?symbol=${query}&limit=${limit}`);
    ...
    async function fetchFundamentals(symbol) {
        try {
            ...
            const profileResponse = await fetch(`https://your-app-name.onrender.com/fetchFundamentals?symbol=${symbol}`);
            const profileData = await profileResponse.json();
            console.log('Profile Data:', profileData);

            // Step 2: Fetch key statistics
            const keyStatsResponse = await fetch(`https://your-app-name.onrender.com/fetchKeyStatistics?symbol=${symbol}`);
            ...
            const incomeStatementResponse = await fetch(`https://your-app-name.onrender.com/fetchIncomeStatement?symbol=${symbol}`);
            ...
            const dividendResponse = await fetch(`https://your-app-name.onrender.com/fetchDividendData?symbol=${symbol}`);
    ...
    document.getElementById('fetchData').addEventListener('click', async () => {
        ...
        try {
            // Fetch FX data
            const fxResponse = await fetch(`https://your-app-name.onrender.com/fxdata?pair=${pair}&period=${period}`);
